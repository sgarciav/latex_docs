...
\address{\Letter \space 2232 Dunseath Ave NW, Apt 106 \textbullet Atlanta, GA 30318}
...
\begin{rSection}{Research Interests}
  ...
  assistive technology, human-robot interaction, computer vision, and
  machine learning.
...
\begin{itemize}
\item Proficient in designing and implementing robust algorithms for autonomous
  ground and aerial mobile robots.
\item Proficient developing advanced computer vision models tailored for object
  detection and segmentation.
\item Experience programming robotic manipulators to perform diverse tasks, and
  integrating their functionalities into broader robotic systems for enhanced
...
\item Proficient in conducting user studies, including experiment design
  and data analysis. \\
\end{itemize}
...
%                        Eclipse \\ % PSpice, LabView

Software Tools & ROS 1 \& ROS 2, Docker, \LaTeX, Emacs, Git, Matlab, \\

\space & Cygwin, CMake, Bash \\
...
\item \simplelistentry{Sloan Scholars Mentoring Network Seed Grant}{RIF
    Robotics}{2024}
