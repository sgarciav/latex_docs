...
\address{e\Letter \space sergiodotgarcia@gmail.com \space \textbullet \space \faGithub github.com/sgarciav}
\address{\Letter \space 2232 Dunseath Ave NW, Apt 106 \space \textbullet \space Atlanta, GA 30318}
...
\item
  ...
  % \item Raised \$650,000 to date, deployed and tested a proof-of-concept
  %   prototype at a local hospital, and
...
\item
  ...
  \item C. Farill, K. DeMarco, and \textbf{S. Garc\'{i}a-Vergara}, ``Robotic
    ...
    % Developed a secondary gripper mechanism, to be attached to any
    % off-the-shelf parallel jaw gripper, allowing for the grasping of
    % scissor-like objects by the finger loops without hindering the pinching
    % capability.
  ...
  \item R.E. Torres-Mu\~{n}iz, \textbf{S.E. Garc\'{i}a-Vergara},
    ...
    % Developed a switch-actuated adapter for joystick controlled wheelchairs
    % such that individuals with limited mobility can continue making use of
    % their chairs and avoid spending money on new ones.
