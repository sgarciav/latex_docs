...
% \item Extensive problem solving skills in academic and industry environments.
...
Engineering Software & ROS1 \& ROS2, Matlab, Simulink, LabView \\ % PSpice, Eclipse, Visual Studio

Operating Systems & Linux, Windows \\

Tools & Docker, CMake, Git, Cygwin, Bash, \LaTeX, Emacs \\

Robotic Platforms & Dingo, DARwin-OP, Pioneer 3-AT, BlueEagle, DJI S1000 \\ % AmigoBot
...
\item Responsible for technical development, fundraising, proposal writing,
  customer interfacing, and
\end{itemize}
...
\item
\begin{itemize}
\item Provided freelance consulting services to the development team to help
  improve autonomy architecture software and build system of the autonomous
  lawnmowers.

\item Tasks included: improved pipeline for obstacle detection and avoidance,
  improved navigation solutions, and
\end{itemize}
