...
\item Extensive experience problem solving skills in academic and industry
  environments.
...
Engineering Software & ROS1 \& ROS2, Matlab, LabView, Simulink \\ % PSpice, Eclipse, Visual Studio
...
\item
\begin{itemize}
\item Automating the surgical instrument pipeline at sterile processing pipeline
  in setrile processing departments at hospitals.

\item Developing computer vision and machine learning models to identify and
  manipulate surgical instruments with robotic arms.
