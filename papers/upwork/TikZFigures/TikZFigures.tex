...
\begin{tikzpicture}[auto, node distance=2.7cm, >=latex']
  ...
  \draw[very thick] (\rt+\r1,\b) -- node[right]{\large D} (\rt+\r1,\r1+\b) arc (270 : 360 : \r2) -- (\rt+\r1+\r2,\r1+\b+\r2+\th) node[right]{\large F} -- (\lt-\r2,\r1+\b+\r2+\th);
  \draw[very thick] (\lt-\r2,\r1+\b+\r2+\th) node[left]{\large E} -- (\lt-\r2,\r1+\r2+\b) arc(180 : 270 : \r2) node[right]{\large I} -- (\lt,\b+\r3) arc(360 : 270 : \r3);
