...
\begin{tikzpicture}[auto, node distance=2.7cm, >=latex']
  ...
  \tikzmath{\ymax = 11; \b = 0.7; \xmax = 5; \width = 0.7; \th = 6.4;}
  \tikzmath{\lt = \xmax - \width/2;}
  \tikzmath{\rt = \xmax - \width/2;}
  \tikzmath{\r1 = 0.8; \r2 = 1.2; \r3 = 1 - \r1;}
  ...
  \draw[very thick] (\lt-\r2,\r2+\th) node[left]{\LARGE E} -- (\lt-\r2,\r1+\r2+\b) arc(180 : 270 : \r2) node[right]{\LARGE I} -- (\lt,\b) arc(360 : 270 : \r3);
  \draw[very thick] (\lt-\r3,\b-\r3) -- (\b+\r3,\b-\r3) arc (270 : 180 : \r3) -- (\b,\ymax) -- (0,\ymax);
